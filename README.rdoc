...
class User < ActiveRecord::Base
  acts_as_authentic do |c|
    c.crowd_base_url "http://localhost:8095/crowd/console"
    c.crowd_application_name "myapp"      # Name of the application in Crowd
    c.crowd_application_password "bogus"  # Password assigned to the application in Crowd
  end
end
